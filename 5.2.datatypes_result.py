...
# message to be sent
message = f'''Hi. we are from Abc learning academy. Your son studying python developer course in our academy. Well, your son takes {total_time} seconds to study the {concept} concept. Then he takes {k22} seconds to finish quiz test and he got {l} marks out of 20. thank you '''
