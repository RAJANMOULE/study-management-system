...
# message to be sent
message = f'''Hi. we are from Abc learning academy. Your son studying python developer course in our academy. Well, your son takes {total_time} time study the {concept} concept. Then he takes {k16} time to take quiz test and he got {l} marks out of 20. thank you '''

try:
# sending the mail
    s.sendmail("gmoulerajan@gmail.com", "aegontargaryen452@gmail.com", message)
...
<h2><center>
Quiz concept :      Datatypes <br><br>

Total Question :  20 <br><br>
''')
print(f'''
